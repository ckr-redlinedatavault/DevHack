...
export default function LandingPage() {
  ...
  return (
    <div className="h-screen w-full bg-[#000000] text-zinc-400 selection:bg-[#4f46e5]/30 font-sans overflow-x-hidden lg:overflow-hidden flex flex-col relative tracking-tight">
      ...
      <main className="flex-1 relative w-full max-w-[90rem] mx-auto px-6 md:px-12 z-10 flex items-center py-4 md:py-8 lg:py-0 overflow-y-auto lg:overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center w-full h-full lg:max-h-full">
          ...
          <div className="flex lg:flex relative items-center justify-center animate-in fade-in zoom-in duration-1000 delay-300 w-full max-w-sm mx-auto lg:max-w-full">
            <div className="absolute inset-0 bg-[#4f46e5]/5 blur-[60px] md:blur-[100px] rounded-full animate-pulse" />
            <img
